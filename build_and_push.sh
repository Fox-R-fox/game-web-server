...
# Fetch DockerHub credentials from AWS Secrets Manager using ARN
echo "Fetching DockerHub credentials from AWS Secrets Manager..."
aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:us-east-1:339712721384:secret:docker-us-JYDQoe --query SecretString --output text > dockerhub_credentials.json
